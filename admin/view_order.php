                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											...
											<tr>
													<td><strong>Smart Cart ID:</strong></td>
													...
													<?php 
																		   ...
																		   <?php 
																			...
																			if($status=="closed")
																				{
																			?>
																			<td>  <center><button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true">order is ready</button></center></td> 
																			<?php 
																			} 
																			?>
																			<?php
