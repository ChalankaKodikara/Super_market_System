							  ...
							  <form action="" method="post">
                                 <div class="row">
								  <div class="form-group col-sm-12">
									...
									<div class="form-group col-sm-6">
                                       <label for="exampleTextarea">Smart Cart ID</label>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>Available Smart Cart ID</a></h4>
                           </div>
