...
<Body>
        ...
        <div class="page-wrapper">
            ...
            <div class="inner-page-hero bg-image" data-image-src="images/img/rest2.jpg">
														   ...
														   <?php 
																		   ...
																		   <?php 
																			...
																			if($status=="closed")
																				{
																			?>
																			 <button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true">Your order is ready</button> 
																			<?php 
																			} 
																			?>
																			<?php
